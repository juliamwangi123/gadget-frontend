              ...
              <div className="flex flex-col sm:px-12  sm:flex-row sm:justify-between sm:pt-16">
                <div className="sm:w-1/5">
                  ...
                  <p className="font-light sm:pt-3">
                    No more meetings with random stranger in parking lots - pick
                    up the gadget at a trusted delivery agent.
                  </p>
                </div>
                <div className="sm:w-1/5 ">
                  <div className="">
                  ...
                  <p className="font-light sm:pt-3">
                    Leave your stack of cash at home, you can buy any gadget on
                    our site with a credit card at affordable price
                  </p>
                </div>
                <div className="sm:w-1/5">
