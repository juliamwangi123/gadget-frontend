    ...
    <div className="w-full">
      ...
      <div className="mt-4 max-w-7xl mx-auto">
        ...
        <div className="flex flex-col-reverse sm:gap-20  sm:flex-row mt-4 sm:mt-12">
          <div className="">
            <h1 className="uppercase text-[20px] font-medium tracking-wider text-center sm:text-start">Checkout</h1>
          ...
          <div className="">
            <h1 className="uppercase text-[20px] font-medium tracking-wider text-center sm:text-start">order summary</h1>
            ...
            <div className="mt-4 sm:mt-8 flex justify-center">
              <Link to="/payment-details" className="py-2.5 px-8 text-[15px] sm:w-full uppercase text-white font-bold rounded-md sm:text-[20px] bg-[#0043C6] hover:bg-black" type="submit">
                confirm order
              </Link>
            </div>
          </div>
