...
const ProductDetails = () => {
  ...
  useEffect(() => {
    // Restore scroll to top when component mounts
              ...
              <section>
                <Fade right>
                  <div className="max-w-[428px] w-full bg-[#F2F9FF]  max-h-[405px] rounded-[10.907px] p-2 px-8 pt-4 sm:px-12 shadow-sm border border-gray-100">
                    ...
                    <div className=" relative w-full">
                      ...
                      >
                        <ul className="text-[15px] list-outside font-light px-4 tracking-wide flex flex-col gap-1">
                          ...
                          <li className="list-disc">
                            Kindly read captions of item descriptions, size,
                            price location before making payment
                          </li>
                          <li className="list-disc">
                            Items must be collected/pickup up after 1-3 days
                            from order delivery.
                          </li>
                        </ul>
                      </div>
                    ...
                    <p className="text-[15px] font-light capitalize">
                      The buyer has 5 day to make any complain Regards to the
                      item
                    </p>
