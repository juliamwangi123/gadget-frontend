...
export const Listproduct = (keyword="") => async (dispatch) => {
  ...
  try {
    ...
    const res = await axios.get(
      `https://web-production-be33.up.railway.app/api/products${keyword}`
    );
    dispatch({
...
export const productDetail = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `https://web-production-be33.up.railway.app/api/products/${id}`
    );
    dispatch({
...
export const submitNewProduct = (product) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `https://web-production-be33.up.railway.app/api/products/newItem/`,
      product,
      config
    );
...
export const userSoldItemsRequest = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `https://web-production-be33.up.railway.app/api/products/sold/items/`,
      config
    );
...
export const userPostedItemsRequest = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `https://web-production-be33.up.railway.app/api/products/myitems/`,
      config
    );
