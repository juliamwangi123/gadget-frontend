...
export const placeOrder = (order) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.post(
      `https://web-production-be33.up.railway.app/api/orders/add/order/`,
      order,
      config
    );
...
export const orderRequest = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.get(
      `https://web-production-be33.up.railway.app/api/orders/${id}/`,
      config
    );
...
export const orderPay = (id) => async (dispatch, getState) => {
  try {
    ...
    const { data } = await axios.put(
      `https://web-production-be33.up.railway.app/api/orders/${id}/pay/`,
     token,
      config
    );
    dispatch({
...
export const userOrderItemsRequest = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `https://web-production-be33.up.railway.app/api/orders/myorder/items/`,
      config
    );
